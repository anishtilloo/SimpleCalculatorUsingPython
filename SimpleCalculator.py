...
e = Entry(root, borderwidth=5, width=35, fg="Blue", bg="White")
...
buttonAdd = Button(root, text="+", padx=40, pady=30, command=button_add)
buttonSub = Button(root, text="-", padx=41, pady=30, command=button_sub)
buttonMultiplication = Button(root, text="*", padx=41, pady=30, command=button_mun)
buttonDivision = Button(root, text="/", padx=41, pady=30, command=button_div)
buttonEqual = Button(root, text="=", padx=90, pady=30, command=button_equal)
buttonClear = Button(root, text="Clear", padx=79, pady=30, command=button_clear)
...
buttonMultiplication.grid(row=6,column=1)
